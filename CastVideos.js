...
CastPlayer.prototype.initializeCastPlayer = function () {
    ...
    options.receiverApplicationId = 'A67CDC89';
...
var PlayerHandler = function (castPlayer) {
    ...
    this.mute = function () {
        ...
        //     castSession.sendMessage("urn:x-cast:ffweb", "authUser").then(res => console.log(res))
        // }
...
CastPlayer.prototype.setupRemotePlayer = function () {
    ...
    // const castSessionMessage = cast.framework.CastContext.getInstance().getSessionState();

    castSession.addMessageListener("urn:x-cast:ffweb", (undefined, message) => {
        console.log(message);
    });
    ...
    playerTarget.load = async function (mediaIndex) {
        console.log('Loading...' + this.mediaContents[mediaIndex]['title']);

        castSession.sendMessage("urn:x-cast:ffweb", JSON.stringify({ type: "auth-user", payload: { token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..yTmePkiCG_Vntbb4bv0wmc_HhpP34rqIQhCzrYk_1WA" } }))
        // const request = new chrome.cast.media.LoadRequest({ assetId: "6877", type: "tv_channel" });

        // const mediaInfo = new chrome.cast.media.MediaInfo("https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", "mp4");



        const mediaInfo = new chrome.cast.media.MediaInfo()
        // mediaInfo.contentId = "6877"
        // mediaInfo.type = "tv_channel"

        // La terminal
        // mediaInfo.contentId = "39546277"
        // mediaInfo.type = "vod"

        // TNT serie
        // mediaInfo.contentId = "322"
        // mediaInfo.type = "tv_channel"

        // FOX COMEDY
        mediaInfo.contentId = "288"
        mediaInfo.type = "tv_channel"
